...
$SCRIPT_DIR/../third_party/zkWasm/target/release/delphinus-cli -k 24 --wasm $SCRIPT_DIR/../output/fib.wasm --function zkmain setup

$SCRIPT_DIR/../third_party/zkWasm/target/release/delphinus-cli -k 24 --wasm $SCRIPT_DIR/../output/fib.wasm --function zkmain single-witness --public 1242044891:i64
